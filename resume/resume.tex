...
\begin{itemize}
	\item Developed iOS application that allowed users to create a profile, take in-app actions linked to nonprofit organizations, research nonprofit organizations, and post comments and pictures to a public stream. 
	\item Created complex database structure for public stream, connecting user profiles to their posts and enabling users to ``like'' others' posts.  
	\item Utilized Parse for scalability, CocoaPods for dependency management, TestFlight for internal testing, and Git for source control.
